<div id="bees-tab"></div>
<div class="bee_buzz" style="position:fixed;z-index: 1000;display:block !important">🐝</div>
<div class="bee_buzz" style="position:fixed;z-index: 1000;display:block">🐝</div>
<div class="bee_buzz" style="position:fixed;z-index: 1000;">🐝</div>
<div class="bee_buzz" style="position:fixed;z-index: 1000;">🐝</div>
<div class="bee_buzz" style="position:fixed;z-index: 1000;">🐝</div>
<div class="bee_buzz" style="position:fixed;z-index: 1000;">🐝</div>
<div class="bee_buzz" style="position:fixed;z-index: 1000;">🐝</div>
...
<canvas id='flower_garden'></canvas>
...
function animateDiv(bee){
	...
	if ($("#bees").hasClass("active")) {
		$("#bees").addClass('tab-pane')
		$("#bees-tab").removeClass('hide')
	} else {
		$("#bees").removeClass('tab-pane')
		$("#bees-tab").addClass('hide')
	}
...
function calcSpeed(prev, next) {
	...
	var speedModifier = 0.08; // Higher number gives the bees more coffee, bees go buzzzzzzzz
	var speed = Math.ceil(greatest/speedModifier);
	return speed;
}

function plant_flowers(){

	var c = document.getElementById("flower_garden");
	var ctx = c.getContext("2d");
	var cw = c.width = (window.innerWidth - 0);
	var ch = c.height = (window.innerHeight - 0);
	var cX = cw / 2,
		cY = ch / 2;
	var rad = Math.PI / 180;
	var howMany = 100;
	...
	document.getElementById("bees-tab").appendChild(c);
